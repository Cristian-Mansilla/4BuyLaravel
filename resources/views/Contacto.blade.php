...
@section('content')
    <main class="container">
        <h2 class="text-center my-5">Envianos tu consulta</h2>
        <div class="inner contact mt-2">
            <!-- Form Area -->
            <div class="contact-form">
                <!-- Form -->
                <form id="contact-us" method="post" action="/Contacto/send">
                    @csrf
                    <!-- Left Inputs -->
                    ...
                    <div class="col-xs-6 wow animated slideInRight" data-wow-delay=".5s">
                        <!-- Message -->
                        <textarea name="mensaje" id="message" class="form textarea"  placeholder="Message"></textarea>
